...
function Page({ params }) {
    ...
    const handleUpdate = async () => {
        ...
        try {
            const response = await axios.put(API_URL, editData, { // PUT은 수정(update)할때 사용한다
                headers: {
                ...
                <Table className="custom-table">
                    <TableBody>
                        ...
                        <TableRow>
                            ...
                            <TableCell className="table-cell">
                                <TextField type='text' multiline rows={4} name="gb_content" value={editData.gb_content} onChange={changItem} sx={{ width: '223px' }}/>
                            </TableCell>
                        </TableRow>
                        <TableRow>
